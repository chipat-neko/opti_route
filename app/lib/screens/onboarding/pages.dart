...
/// ════════════════════════════════════════════════════════════════
/// Les 5 pages du walkthrough d'onboarding + l'indicateur de progression.
/// ════════════════════════════════════════════════════════════════
///
/// Extrait de `onboarding_screen.dart` (756 lignes initiales) pour
/// alleger l'orchestration du PageController dans le screen parent.
/// Toutes les pages sont stateless ; [PageOrsKey] est la seule qui
/// recoit un controller (le screen possede le TextEditingController de
/// la cle ORS car la valeur est persistee dans le `_finish`).
...
/// demarre).
/// ────────────────────────────────────────────────────────────────
class PageConcept extends StatelessWidget {
  const PageConcept({super.key});
...
/// ────────────────────────────────────────────────────────────────
class PageChefEquipe extends StatelessWidget {
  const PageChefEquipe({super.key});
...
/// saisir et la mettre plus tard depuis Parametres > Optimisation.
/// ────────────────────────────────────────────────────────────────
class PageOrsKey extends StatelessWidget {
  const PageOrsKey({super.key, required this.controller});
