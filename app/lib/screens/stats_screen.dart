...
/// Stats par coequipier sur les 30 derniers jours. Affiche un mini
/// tableau "Avatar - Nom - X livres / Y echecs - Z colis". Cachee si
/// aucun coequipier n'a ete affecte sur la periode.
class _CoequipiersStatsCard extends ConsumerWidget {
  const _CoequipiersStatsCard();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Tri : Noah en haut, puis coequipiers par colis livres desc.
