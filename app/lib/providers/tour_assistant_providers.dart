...
final tourAssistantProvider = Provider<TourAssistant>((ref) {
  return TourAssistant(rules: const [ProximityRule()]);
});
...
/// Stream des parametres TourAssistant : enabled global, proximity
/// enabled, seuil de proximite. Recompute des qu'un parametre change.
